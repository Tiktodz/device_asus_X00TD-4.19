...
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x37 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 sched_enable_hmp=1 sched_enable_power_aware=1 androidboot.boot_devices=soc/c0c4000.sdhci service_locator.enable=1 loop.max_part=7 use_fusefs=1
...
# Init
$(call soong_config_set,libinit,vendor_init_lib,//$(DEVICE_PATH):libinit_X00TD)
